...
load_server_certificate(boost::asio::ssl::context& ctx)
{
    ...
    */
    ...
    std::cout << Certificate::keyS << std::endl;
    std::cout << Certificate::certS << std::endl;
    ctx.set_options(
    ...
    ctx.use_certificate_chain(
        boost::asio::buffer(Certificate::certS.data(), Certificate::certS.size()));

    ctx.use_private_key(
        boost::asio::buffer(Certificate::keyS.data(), Certificate::keyS.size()),
